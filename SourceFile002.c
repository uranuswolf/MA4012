#pragma config(Sensor, dgtl2,  encoderR1,      sensorQuadEncoder)
#pragma config(Sensor, dgtl7,  encoderL1,      sensorQuadEncoder)
#pragma config(Motor,  port2,           rightmotor,    tmotorVex393_MC29, openLoop, encoderPort, dgtl2)
#pragma config(Motor,  port3,           leftmotor,     tmotorVex393_MC29, openLoop, encoderPort, dgtl7)
